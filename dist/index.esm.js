...
import { unstable_now, unstable_scheduleCallback, unstable_cancelCallback } from 'scheduler';
...
const Canvas = (_ref) => {
  ...
  useEffect(() => {
    setTimeout(() => {
      ...
      }, React.createElement("renderWrapper", null, children)), state.current.container);
    });
  });
...
export { Canvas, render, useP5Event, useDraw, useP5, useP5Effect, useP5LayoutEffect, useKeyPressed, useKeyReleased, useKeyTyped, useMouseMoved, useMouseDragged, useMousePressed, useMouseReleased, useMouseClicked, useDoubleClicked, useMouseWheel, useTouchStarted, useTouchMoved, useTouchEnded, useDeviceMoved, useDeviceTurned, useDeviceShaken };
